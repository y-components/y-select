...
(function(process) {
  ...
  System.config({"map": {
      ...
      "github:jspm/nodelibs-buffer@0.1.0": {"buffer": "npm:buffer@3.0.3"},
      "github:jspm/nodelibs-constants@0.1.0": {"constants-browserify": "npm:constants-browserify@0.0.1"},
      "github:jspm/nodelibs-crypto@0.1.0": {"crypto-browserify": "npm:crypto-browserify@3.9.13"},
      ...
      "github:jspm/nodelibs-process@0.1.1": {"process": "npm:process@0.10.0"},
